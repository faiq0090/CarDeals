...
class sellcar : Fragment() {
    ...
    override fun onCreateView(
        ...
        val cities = arrayOf("Islamabad", "Lahore", "Karachi", "Peshawar", "Multan", "Quetta", "Faisalabad")
        ...
        carType.adapter = ArrayAdapter(requireContext(), android.R.layout.simple_spinner_dropdown_item, carTypes)
        carModel.adapter = ArrayAdapter(requireContext(), android.R.layout.simple_spinner_dropdown_item, carModels)
        city.adapter = ArrayAdapter(requireContext(), android.R.layout.simple_spinner_dropdown_item, cities)
        model.adapter = ArrayAdapter(requireContext(), android.R.layout.simple_spinner_dropdown_item, years)
        bodyType.adapter = ArrayAdapter(requireContext(), android.R.layout.simple_spinner_dropdown_item, bodyTypes)
        color.adapter = ArrayAdapter(requireContext(), android.R.layout.simple_spinner_dropdown_item, colors)
        fuelType.adapter = ArrayAdapter(requireContext(), android.R.layout.simple_spinner_dropdown_item, fuel)
        registered.adapter = ArrayAdapter(requireContext(), android.R.layout.simple_spinner_dropdown_item, registeredList)
        transmissionType.adapter = ArrayAdapter(requireContext(), android.R.layout.simple_spinner_dropdown_item, transmissionList)
    ...
    private fun uploadCarData() {
        ...
        val request = object : StringRequest(Method.POST, url,
            { response ->
                Toast.makeText(requireContext(), "Car uploaded successfully!", Toast.LENGTH_LONG).show()
